import {helpWithAiWilli} from './ai-willi-helper.js?v=1.5.0';
import {AI_WILLI_NAME,aiWilliMessage} from './ai-willi-messages.js?v=1.0.0';
import {getCachedAiWilliExplanation,saveAiWilliExplanation,rateAiWilliExplanation} from './ai-willi-cache.js?v=1.3.0';
