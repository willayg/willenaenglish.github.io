...
import {createSpeakingAssessment} from './speaking-assessment.js?v=20260912-phase5q5';
import {
  SESSION_PHASE,
  SESSION_STATUS,
...
const T={
  ko:{brand:'무료 영어 레벨 테스트',footer:'Willena English · 스테이징 진단 테스트',title:'레벨 테스트',start:'시작하기',resume:'이전 테스트 계속하기',newTest:'새 테스트',handoff:'학생 정보가 준비되었습니다',handoffText:'선생님이 먼저 말하기 평가를 진행합니다.',back:'뒤로',edit:'정보 수정',continue:'말하기 평가로 이동',done:'말하기 평가가 저장되었습니다',doneText:'다음 단계에서 말하기 추천 레벨과 시작 레벨 선택이 연결됩니다.'},
  en:{brand:'Free Level Test',footer:'Willena English · Staging assessment',title:'Level Test',start:'Start',resume:'Resume previous test',newTest:'New test',handoff:'Student information is ready',handoffText:'The teacher completes the speaking assessment first.',back:'Back',edit:'Edit details',continue:'Continue to speaking',done:'Speaking assessment saved',doneText:'The speaking recommendation and start-level decision are connected in the next phase.'}
};
