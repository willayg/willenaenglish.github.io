...
(function(){
	...
	const map = {
		en: {
			...
			'English Arcade':'English Arcade','Word Arcade':'Word Arcade','Grammar Arcade':'Grammar Arcade','Challenge Zone':'Challenge Zone','My Profile':'My Profile','Change Password':'Change Password','Change Email':'Change Email','View Profile':'View Profile','Logout':'Logout','Language':'Language','Korean':'Korean','English':'English','Dark Mode':'Dark Mode','Music':'Music','Off':'Off','Arcade Tagline':'Master English with word arcade and grammar arcade',
			...
			'Student Login':'Student Login','Use your username and password.':'Use your username and password.','Username':'Username','Password':'Password','Log in':'Log in','Guest Login':'Guest Login','Please enter both username and password.':'Please enter both username and password.','Enter your name to play as a guest:':'Enter your name to play as a guest:','Login failed':'Login failed','Guest login failed':'Guest login failed','Username not found':'Username not found','notApproved':'Account not approved. Please ask your teacher.',
			...
			// Mode menu labels
			'Loading leaderboard':'Loading leaderboard','Failed to load':'Failed to load','No data available':'No data available',
			...
			// NOTE: User requested specific forms: Word Arcade => 단어 오락실, 3X Challenge => 3x 도전
				'Dashboard':'대시보드','Welcome':'환영합니다','Start Playing':'시작하기','Account':'계정','Settings':'설정','Your Work':'내 작업','Class':'반','Coming soon':'곧 제공','Back':'뒤로','Start':'시작','Start Game Now':'지금 게임 시작','More Games':'더 많은 게임','Kor':'한','Eng':'영','English Arcade':'영어 아케이드','Word Arcade':'단어 오락실','Grammar Arcade':'문법 아케이드','Challenge Zone':'챌린지 존','My Profile':'내 프로필','Change Password':'비밀번호 변경','Change Email':'이메일 변경','View Profile':'프로필 보기','Logout':'로그아웃','Language':'언어','Korean':'한국어','English':'영어','Dark Mode':'다크 모드','Music':'음악','Off':'끔','Arcade Tagline':'단어 오락실과 문법 아케이드로 영어 실력을 키워 보세요',
				'Loading leaderboard':'리더보드 불러오는 중','Failed to load':'불러오기 실패','No data available':'데이터가 없습니다',
			...
			'Student Login':'학생 로그인','Use your username and password.':'사용자 이름과 비밀번호를 입력하세요.','Username':'사용자 이름','Password':'비밀번호','Log in':'로그인','Guest Login':'게스트 로그인','Please enter both username and password.':'아이디와 비밀번호를 모두 입력하세요.','Enter your name to play as a guest:':'게스트 이름을 입력하세요:','Login failed':'로그인 실패','Guest login failed':'게스트 로그인 실패','Username not found':'사용자 이름을 찾을 수 없습니다','notApproved':'계정이 승인되지 않았습니다. 선생님께 문의하세요.',
