...
(function(){
	...
	const map = {
		en: {
			'Dashboard':'Dashboard','Start Playing':'Start Playing','Account':'Account','Settings':'Settings','Your Work':'Your Work','Class':'Class','Coming soon':'Coming soon',
			...
			'Basic':'Basic','Your Work (Short)':'Your Work','3X Challenge':'3X Challenge','Discover':'Discover','Loading game…':'Loading game…','Menu':'Menu','Levels':'Levels',
		...
		ko: {
			...
			'Dashboard':'대시보드','Start Playing':'시작하기','Account':'계정','Settings':'설정','Your Work':'내 작업','Class':'반','Coming soon':'곧 제공','Word Arcade':'단어 오락실','Grammar Arcade':'문법 아케이드','Challenge Zone':'챌린지 존','My Profile':'내 프로필','Change Password':'비밀번호 변경','Change Email':'이메일 변경','View Profile':'프로필 보기','Logout':'로그아웃','Language':'언어','Korean':'한국어','English':'영어','Dark Mode':'다크 모드','Music':'음악','Off':'끔',
			'Basic':'기초','Your Work (Short)':'내 작업','3X Challenge':'3x 도전','Discover':'탐색','Loading game…':'게임 불러오는 중…','Menu':'메뉴','Levels':'레벨',
