...
function ensureStyles(){
  ...
  const s=document.createElement('style');s.id=STYLE_ID;s.textContent=`.ai-willi-vocab{margin:14px 0 0;padding:14px 15px;border:1.5px solid #bfe7ea;border-radius:16px;background:linear-gradient(180deg,#f7feff,#f0fbfc);color:#263d44;box-shadow:0 5px 18px rgba(36,92,99,.07);font-family:Poppins,system-ui,sans-serif}.ai-willi-vocab-head{display:flex;align-items:center;gap:8px;color:#ee5f91;font-weight:800;font-size:15px}.ai-willi-vocab-mark{display:inline-flex;align-items:center;justify-content:center;width:26px;height:26px;border-radius:50%;background:#ffe8f2;color:#ee5f91}.ai-willi-vocab-text{margin-top:10px;padding:10px 12px;border:1px solid #d8ecee;border-radius:14px;background:#fff;font-size:17px;line-height:1.7;font-weight:600;color:#344d55}.ai-willi-vocab-text strong{font-weight:900}.ai-willi-vocab-actions{display:flex;gap:8px;flex-wrap:wrap;margin-top:11px}.ai-willi-vocab button{min-height:40px;padding:0 14px;border:1.5px solid #86d9df;border-radius:12px;background:#fff;color:#d9467d;font:800 14px Poppins,system-ui,sans-serif}.ai-willi-vocab button:disabled{opacity:.55}.ai-willi-vocab-thinking{display:inline-flex;gap:5px;align-items:center}.ai-willi-vocab-thinking i{width:7px;height:7px;border-radius:50%;background:#ee5f91;opacity:.4;animation:aiWilliVocabDot 1s ease-in-out infinite}.ai-willi-vocab-thinking i:nth-child(2){animation-delay:.14s}.ai-willi-vocab-thinking i:nth-child(3){animation-delay:.28s}@keyframes aiWilliVocabDot{0%,60%,100%{transform:translateY(0);opacity:.3}30%{transform:translateY(-4px);opacity:1}}`;
