...
const THEMES={
  ...
  sunbeam:{
    '--cyan':'#f0cc6d','--cyan-dark':'#c58b00','--pink':'#ef4e87','--ink':'#40341d','--muted':'#857a64','--page':'#fffdf5','--card':'#ffffff','--soft':'#fff4c8','--line':'#f0cc6d','--track':'#f5eccd','--accent':'#e6a400','--header-a':'#ffe67b','--header-b':'#ffc24c','--header-c':'#ffb130','--heading':'#4c3500','--action-bg':'#ffffff','--action-border':'#f0cc6d','--action-text':'#ef4e87','--shadow':'0 12px 28px rgba(197,139,0,.10)','--card-accent':'#5f9fd8','--card-accent-dark':'#2f679d','--card-soft':'#eef6fd','--card-line':'#a9c9e8','--card-shadow':'rgba(58,116,171,.12)'
  },
  pink:{
