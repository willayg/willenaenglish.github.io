...
global.addEventListener('willena:activity-answer',function(event){var activity=event&&event.detail&&event.detail.activity,meta=activity&&activity.metadata||{};if(meta.daily_test_mode===true||meta.morphology_sidecar===true)return;record(event.detail);});
