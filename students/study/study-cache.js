...
function renderSummary(summary){if(!summary)return false;var b=document.getElementById('bookTitle'),u=document.getElementById('unitTitle'),did=false;if(b&&summary.bookTitle){b.textContent=summary.bookTitle;did=true;}if(u&&summary.unitText){u.textContent=summary.unitText;did=true;}return did;}
...
global.WillenaStudyCache={version:'study-cache-v2',prime:prime,clearUser:clearUser,clearAll:clearAll,currentUserId:currentUserId};
})(window);