...
async function loadQuestionHistory(planId){const api=window.WillenaTestPrepSession;if(!api?.history)return[];try{return await api.history(planId,null,null)}catch(e){console.warn('[exam] question history unavailable',e);return[]}}
