...
function boot(){addStyles();addStudentsBadge();document.addEventListener('click',intercept,true);console.info('[Test Prep] Students Rev3 active')}
window.WillenaStudentsRev2={renderJourney};
