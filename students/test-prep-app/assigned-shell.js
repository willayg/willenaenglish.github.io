...
let selection=null,practiceOpen=false;
...
// REV39: only the sentence module still needs dynamic loading here.
// Legacy tracking-phase1 and the deleted vocab-test-practice loader are intentionally gone.
addScript('./sentence-practice.js?v=20260905-rev39-surface-owner1','data-testprep-sentence-practice');
  ...
  header.innerHTML=`
    ...
    <div class="tp-header-inner">
      ...
      <div class="tp-header-brand">
        <div class="tp-header-title">내신 명중</div>
...
function activePracticeState(){return practiceOpen}
function enterPracticeSurface(){practiceOpen=true;home.style.display='none';quiz.style.display='block';return true}
function closePracticeSurface(){const wasOpen=practiceOpen||quiz.style.display!=='none';practiceOpen=false;restorePractice();quiz.style.display='none';home.style.display='block';selection=null;return wasOpen}
function showHomeSurface(){if(practiceOpen)return false;quiz.style.display='none';home.style.display='block';return true}
function renderHome(){if(practiceOpen)return false;restorePractice();selection=null;showHomeSurface();home.innerHTML='<div class="tp-shell-loading">시험 대비를 불러오는 중...</div>';return true}
...
window.WillenaAssignedTestPrep={init,renderHome,startSelection,questionQuery,showHomeSurface,closePracticeSurface,leavePractice,isPracticeOpen:()=>practiceOpen,get selection(){return selection}};
console.info('[Test Prep REV39] assigned shell owns practice surface');
})();