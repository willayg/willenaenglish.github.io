...
const THEMES={
  cyan:{
    '--tp-cyan':'#67d4da','--tp-cyan-dark':'#07888d','--tp-pink':'#ee5f91','--tp-ink':'#203039','--tp-muted':'#7c8b92','--tp-page':'#f3feff','--tp-card':'#ffffff','--tp-soft':'#e9fbfc','--tp-line':'#9de2e7','--tp-track':'#dff3f5','--tp-accent':'#15aab5','--tp-header-a':'#baf8fb','--tp-header-b':'#65e3eb','--tp-header-c':'#39c9d6','--tp-heading':'#064e57'
  },
  sunbeam:{
    '--tp-cyan':'#f0cc6d','--tp-cyan-dark':'#c58b00','--tp-pink':'#ef4e87','--tp-ink':'#40341d','--tp-muted':'#857a64','--tp-page':'#fffdf5','--tp-card':'#ffffff','--tp-soft':'#fff4c8','--tp-line':'#f0cc6d','--tp-track':'#f5eccd','--tp-accent':'#e6a400','--tp-header-a':'#ffe67b','--tp-header-b':'#ffc24c','--tp-header-c':'#ffb130','--tp-heading':'#4c3500'
  },
  pink:{
    '--tp-cyan':'#f5b8d2','--tp-cyan-dark':'#d54685','--tp-pink':'#d83b7b','--tp-ink':'#4a2c39','--tp-muted':'#8b7480','--tp-page':'#fff7fb','--tp-card':'#ffffff','--tp-soft':'#ffe8f2','--tp-line':'#f5b8d2','--tp-track':'#f8dfeb','--tp-accent':'#ed5c9d','--tp-header-a':'#ffd7e8','--tp-header-b':'#ff9fc8','--tp-header-c':'#f775ad','--tp-heading':'#7d2850'
  }
};
