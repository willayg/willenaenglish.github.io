...
function installStyles(){
 if(document.getElementById('tpWrong49aStyles'))return;
 const s=document.createElement('style');s.id='tpWrong49aStyles';s.textContent=`
 ...
 .tp49-wrong-icon{width:58px;height:58px;border-radius:18px;background:#fff0f5;color:#f24a8c;display:grid;place-items:center;font-size:30px;font-weight:800}
 .tp49-wrong-copy b{display:block;font-size:22px;font-weight:800}.tp49-wrong-copy small{display:block;margin-top:7px;color:#7a8b90;font-size:13px;font-weight:600}
 .tp49-wrong-count{text-align:right}.tp49-wrong-count strong{display:block;color:#f23879;font-size:42px;line-height:1;font-weight:800}.tp49-wrong-count small{display:block;color:#7a8b90;font-size:11px;font-weight:700;margin-top:7px}
 .tp49-wrong-chips{grid-column:2/4;display:flex;gap:8px;flex-wrap:wrap}.tp49-wrong-chip{display:inline-flex;align-items:center;padding:6px 10px;border-radius:999px;background:#f3f8f8;color:#61747b;font-size:11px;font-weight:800}.tp49-wrong-chip.ready{background:#eaf8f4;color:#19777e}
 .tp49-wrong-loading{opacity:.72}.tp49-wrong-error{border-color:#efc8c8}.tp49-wrong-error .tp49-wrong-copy small{color:#a14b4b}
 @media(max-width:600px){.tp49-wrong-card{padding:20px 18px;gap:14px;grid-template-columns:auto 1fr auto}.tp49-wrong-icon{width:52px;height:52px}.tp49-wrong-copy b{font-size:20px}.tp49-wrong-copy small{font-size:12px}.tp49-wrong-count strong{font-size:38px}.tp49-wrong-chips{grid-column:1/4}}
...
console.log('[REV49a] wrong-answer home card is a standalone owner');
})();