...
async function loadStage5(){
  if(global.WillenaCoachLearnerState&&global.WillenaCoachConceptRetriever&&global.WillenaCoachStage5Capability){
    ...
    if(!global.WillenaCoachStage5SkillCapability&&!document.getElementById('v3Stage5SkillCapability'))loadScript('v3Stage5SkillCapability','./v3-ai-coach-stage5-skill-capability.js?v=20260823-stage5skill2').catch(function(e){console.warn('[AI Coach bootstrap] Stage 5 skill capability load failed',e);});
    if(!document.getElementById('v3Stage5DebugScript'))loadScript('v3Stage5DebugScript','./v3-stage5-debug.js?v=20260823-stage5debug3').catch(function(e){console.warn('[AI Coach bootstrap] Stage 5 debug load failed',e);});
    return true;
  }
  ...
  stage5Loading=(async function(){
    try{
      ...
      if(!global.WillenaCoachStage5Capability)await loadScript('v3Stage5Capability','./v3-ai-coach-stage5-capability.js?v=20260823-stage5a4');
      ...
      if(!global.WillenaCoachStage5SkillCapability)await loadScript('v3Stage5SkillCapability','./v3-ai-coach-stage5-skill-capability.js?v=20260823-stage5skill2');
      await loadScript('v3Stage5DebugScript','./v3-stage5-debug.js?v=20260823-stage5debug3').catch(function(e){console.warn('[AI Coach bootstrap] Stage 5 debug load failed',e);});
