...
function buildUi(){
  ...
  var open=document.createElement('button');open.type='button';open.id='studySettingsBtn';open.setAttribute('aria-haspopup','dialog');daily.insertAdjacentElement('afterend',open);
