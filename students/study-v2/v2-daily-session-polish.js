...
function ensureMorphologyCoachMenu(){
  ...
  var s=document.createElement('script');s.id='v2MorphologyCoachMenuScript';s.src='/students/study-v2/v2-morphology-coach-menu.js?v=20260820-maintenance3';s.async=true;(document.head||document.documentElement).appendChild(s);
}
