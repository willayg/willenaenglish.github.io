import {QuestionRenderer} from '/shared/questions/question-renderer.js?v=20260925-spelling4';
...
async function boot(){
  try{
    ...
    window.WillenaVocabStudy={version:'0.006',getState:()=>state,start:startSession,openSpellingPreview,close:closeSession};
  }catch(error){
