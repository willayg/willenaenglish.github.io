...
const fallbackHave = [
  ...
  { id: 'fb_have_parents', word: 'My parents', prompt: 'My parents ___ a car.', exampleSentence: 'My parents have a car.', exampleSentenceKo: '¯C ¥è   ?.', emoji: '??' }
];
