...
export async function runGrammarLessonHaveHas(ctx = {}) {
  ...
  function renderExamplesStep(stepEl, progress) {
    ...
    intro.className = 'lesson-body';
    intro.innerHTML = lang === 'ko'
      ? "<b>�� ��/�� ����</b>�� <b>has</b> (������)<br/><b>���� ��/���� ����</b>�� <b>have</b> (������)<br/>��ư�� ������ ������ Ȯ���� ������!"
    ...
    const renderCard = (typeId, advance) => {
      ...
      cardDisplay.innerHTML = `
        ...
        <div class="verb-tip">${escapeHtml(lang === 'ko' ? (typeId === 'singular' ? '�� ��/�� ���ǿ��� has' : '���� ��/���� ���ǿ��� have') : (typeId === 'singular' ? 'One person or thing uses has' : 'More than one uses have'))}</div>
      `;
    };
  ...
  function renderSortingStep(stepEl, progress) {
    ...
    const checkBtn = buildPrimaryButton(lang === 'ko' ? '���� Ȯ��' : 'Check Answers');
    checkBtn.style.marginTop = '16px';
    stepEl.appendChild(checkBtn);

    const nav = document.createElement('div');
    nav.className = 'lesson-nav';
    const backBtn = buildSecondaryButton(lang === 'ko' ? '�ڷ�' : 'Back');
    ...
    checkBtn.onclick = () => {
      ...
      if (allCorrect) {
        ...
        message.textContent = lang === 'ko' ? '�Ϻ��ؿ�! have/has�� �� ������.' : 'Great! You used have/has correctly.';
        stepEl.insertBefore(message, stepEl.firstChild);
        
        if (!continueBtn) {
          continueBtn = buildPrimaryButton(lang === 'ko' ? '���� �ܰ��' : 'Next Step');
        ...
        message.textContent = lang === 'ko' ? '���� ������ �ٽ� �Ű� ������.' : 'Try again! Fix the red subjects.';
        stepEl.insertBefore(message, stepEl.firstChild);
      }
    };
  }
  ...
  function renderFinishStep(stepEl) {
    ...
    body.innerHTML = (lang === 'ko')
      ? '<div style="font-weight:800;color:#19777e">���� have/has�� �ٸ��� ��� �� �־��!</div><div class="stars">?????</div>'
      : '<div style="font-weight:800;color:#19777e">You now know when to use have or has!</div><div class="stars">?????</div>';
    stepEl.appendChild(body);

    const nav = document.createElement('div');
    nav.className = 'lesson-nav';
    const backBtn = buildPrimaryButton(lang === 'ko' ? '���� ���ư���' : 'Back to Modes');
    backBtn.onclick = () => {
      if (window.WordArcade?.startGrammarModeSelector) {
        window.WordArcade.startGrammarModeSelector();
      } else if (window.WordArcade?.quitToOpening) {
...
function buildExampleColumn(type, list, lang) {
  ...
  const subjects = (type === 'have')
    ...
    : (lang === 'ko' ? 'he / she / it / �ܼ� ���' : 'he / she / it / singular nouns');
  ...
  return [
    {
      ...
      sentenceKo: haveExample.exampleSentenceKo || '���� ���� �� �ڷ縦 ������ �־��.',
      tipEn: "Use 'have' with I, you, we, they, or plural nouns.",
      tipKo: "I, you, we, they �׸��� ���� ��翡 'have'�� ���.",
      label: 'I / You / We / They'
    },
    {
      id: 'has',
...
const fallbackHave = [
  { id: 'fb_have_i', word: 'I', prompt: 'I ___ two pencils.', exampleSentence: 'I have two pencils.', exampleSentenceKo: '���� ���� �� �ڷ縦 ������ �־��.', emoji: '??' },
  { id: 'fb_have_we', word: 'We', prompt: 'We ___ music class.', exampleSentence: 'We have music class.', exampleSentenceKo: '�츮�� ���� ������ �־��.', emoji: '??' },
  { id: 'fb_have_they', word: 'They', prompt: 'They ___ a big house.', exampleSentence: 'They have a big house.', exampleSentenceKo: '�׵��� ū ���� �־��.', emoji: '??' },
  { id: 'fb_have_parents', word: 'My parents', prompt: 'My parents ___ a car.', exampleSentence: 'My parents have a car.', exampleSentenceKo: '�츮 �θ���� ���� ������ �־��.', emoji: '??' }
];

const fallbackHas = [
  { id: 'fb_has_he', word: 'He', prompt: 'He ___ a bike.', exampleSentence: 'He has a bike.', exampleSentenceKo: '�״� �����Ÿ� ������ �־��.', emoji: '??' },
  { id: 'fb_has_she', word: 'She', prompt: 'She ___ long hair.', exampleSentence: 'She has long hair.', exampleSentenceKo: '�׳�� �� �Ӹ��� ������ �־��.', emoji: '???��?' },
  { id: 'fb_has_it', word: 'It', prompt: 'It ___ four legs.', exampleSentence: 'It has four legs.', exampleSentenceKo: '�װ��� �ٸ��� �� �� �־��.', emoji: '??' },
  { id: 'fb_has_friend', word: 'My friend', prompt: 'My friend ___ a pencil case.', exampleSentence: 'My friend has a pencil case.', exampleSentenceKo: '�� ģ���� ������ �־��.', emoji: '???' }
];