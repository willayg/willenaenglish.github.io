...
export async function runGrammarLessonDontDoesnt(ctx = {}) {
  ...
  function renderExplainStep(stepEl, progress) {
    ...
    intro.innerHTML = lang === 'ko'
      ? "부정문을 만들 때 <b>don't</b> (I/you/we/they), <b>doesn't</b> (he/she/it)를 써요. 버튼을 눌러서 예제를 확인해 보세요!"
  ...
  function renderExamplesStep(stepEl, progress) {
    ...
    intro.className = 'lesson-body';
    intro.innerHTML = lang === 'ko'
      ? "<b>I/You/We/They</b> → <b>Don't</b><br/><b>He/She/It</b> → <b>Doesn't</b><br/>버튼을 눌러서 더 많은 예제를 확인하세요!"
  ...
  function renderSortingStep(stepEl, progress) {
    ...
    intro.className = 'lesson-body';
    intro.innerHTML = (lang === 'ko')
      ? '주어를 눌러 <b>Don\'t</b> 또는 <b>Doesn\'t</b> 바구니에 넣어 보세요. 모두 맞으면 다음 단계로 넘어갈 수 있어요.'
    ...
    checkBtn.onclick = () => {
      ...
      if (allCorrect) {
        ...
        message.textContent = lang === 'ko' ? '완벽해요! don\'t/doesn\'t를 잘 골랐어요.' : 'Perfect! You used don\'t/doesn\'t correctly.';
  ...
  function renderFinishStep(stepEl) {
    ...
    body.innerHTML = (lang === 'ko')
      ? '<div style="font-weight:800;color:#19777e">이제 don\'t/doesn\'t를 바르게 사용할 수 있어요!</div><div class="stars">⭐⭐⭐⭐⭐</div>'
  ...
  return [
    {
      ...
      sentenceKo: dontExample.exampleSentenceKo || '나는 브로콜리를 좋아하지 않아요.',
      tipEn: "Use 'don't' with I, you, we, they.",
      tipKo: "I, you, we, they에 대해 'don't'를 써요.",
      label: '👥 Don\'t'
    },
    {
      id: 'doesnt',
      ...
      sentenceKo: doesntExample.exampleSentenceKo || '그는 TV를 보지 않아요.',
      tipEn: "Use 'doesn't' with he, she, it.",
      tipKo: "he, she, it에 대해 'doesn't'를 써요.",
      label: '👤 Doesn\'t'
    }
  ];
}
...
const fallbackDont = [
  { id: 'fb_dont_like', word: 'I', exampleSentence: 'I don\'t like broccoli.', exampleSentenceKo: '나는 브로콜리를 좋아하지 않아요.', emoji: '🥦' },
  { id: 'fb_dont_need', word: 'You', exampleSentence: 'You don\'t need to hurry.', exampleSentenceKo: '서두를 필요 없어요.', emoji: '🏃' },
  { id: 'fb_dont_want', word: 'We', exampleSentence: 'We don\'t need help.', exampleSentenceKo: '우리는 도움이 필요 없어요.', emoji: '🙏' },
  { id: 'fb_dont_play', word: 'They', exampleSentence: 'They don\'t play soccer.', exampleSentenceKo: '그들은 축구를 하지 않아요.', emoji: '⚽' }
];

const fallbackDoesnt = [
  { id: 'fb_doesnt_watch', word: 'He', exampleSentence: 'He doesn\'t watch TV.', exampleSentenceKo: '그는 TV를 보지 않아요.', emoji: '📺' },
  { id: 'fb_doesnt_want', word: 'She', exampleSentence: 'She doesn\'t want that.', exampleSentenceKo: '그녀는 그것을 원하지 않아요.', emoji: '👩' },
  { id: 'fb_doesnt_work', word: 'It', exampleSentence: 'It doesn\'t work.', exampleSentenceKo: '그것은 작동하지 않아요.', emoji: '⚙️' },
  { id: 'fb_doesnt_like', word: 'John', exampleSentence: 'John doesn\'t like vegetables.', exampleSentenceKo: '존은 채소를 좋아하지 않아요.', emoji: '🥗' }
];
