...
export async function runGrammarLessonDontDoesnt(ctx = {}) {
  ...
  function renderExplainStep(stepEl, progress) {
    ...
    intro.innerHTML = lang === 'ko'
      ? "영어에서 <b>don't</b>는 I/you/we/they와 함께, <b>doesn't</b>는 he/she/it과 함께 부정문을 만듭니다. 버튼을 탭해서 예문을 확인하세요!"
  ...
  function renderExamplesStep(stepEl, progress) {
    ...
    intro.className = 'lesson-body';
    intro.innerHTML = lang === 'ko'
      ? "<b>I/You/We/They</b>는 <b>Don't</b><br/><b>He/She/It</b>는 <b>Doesn't</b><br/>각 버튼을 눌러 예시를 더 확인해보세요!"
  ...
  function renderSortingStep(stepEl, progress) {
    ...
    checkBtn.onclick = () => {
      ...
      if (allCorrect) {
        ...
        message.textContent = lang === 'ko' ? '완벽해요! don\'t/doesn\'t를 올바르게 사용했어요.' : 'Perfect! You used don\'t/doesn\'t correctly.';
  ...
  function renderFinishStep(stepEl) {
    ...
    body.innerHTML = (lang === 'ko')
      ? '<div style="font-weight:800;color:#19777e">축하합니다! 이제 don\'t와 doesn\'t를 언제 쓰는지 알게 되었어요!</div><div class="stars">⭐⭐⭐⭐⭐</div>'
  ...
  return [
    {
      ...
      sentenceKo: dontExample.exampleSentenceKo || '저는 브로콜리를 좋아하지 않아요.',
      tipEn: "Use 'don't' with I, you, we, they.",
      tipKo: "I, you, we, they와 함께 'don't'를 사용합니다.",
      label: 'Don\'t'
    },
    {
      id: 'doesnt',
      ...
      tipKo: "he, she, it와 함께 'doesn't'를 사용합니다.",
      label: 'Doesn\'t'
    }
  ];
}
...
const fallbackDont = [
  { id: 'fb_dont_like', word: 'I', exampleSentence: 'I don\'t like broccoli.', exampleSentenceKo: '저는 브로콜리를 좋아하지 않아요.', emoji: '🥦' },
  { id: 'fb_dont_need', word: 'You', exampleSentence: 'You don\'t need to hurry.', exampleSentenceKo: '서두를 필요가 없어요.', emoji: '⏳' },
  { id: 'fb_dont_want', word: 'We', exampleSentence: 'We don\'t need help.', exampleSentenceKo: '우리는 도움이 필요하지 않아요.', emoji: '🙅' },
