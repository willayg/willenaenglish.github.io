...
if not API_KEY or not VOICE_ID:
    raise ValueError("Missing ELEVENLABS_API_KEY or ELEVENLABS_VOICE_ID in .env file.")

print("Current directory:", os.getcwd())
print("Files in directory:", os.listdir('.'))

if not os.path.exists("lg6_SENTENCES.md"):
    print("lg6_SENTENCES.md not found!")
else:
    print("lg6_SENTENCES.md found!")

with open("lg6_SENTENCES.md", "r", encoding="utf-8") as f:
