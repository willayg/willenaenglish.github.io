...
fetch(sourceUrl,{cache:'no-store'}).then(function(response){
 ...
 source=replaceOnce(source,
  ...
  'function startAbility(years,grade){var matrix={1:{0:1,1:1.5,2:2,4:2.5,6:3},2:{0:1,1:2,2:3,4:4,6:5},4:{0:1.5,1:2.5,2:4,4:5.5,6:6.5},6:{0:2,1:3,2:4.5,4:6,6:7.5},8:{0:2.5,1:3.5,2:5,4:7,6:8.5},9:{0:3,1:4,2:5.5,4:7.5,6:9}},stage=matrix[Number(grade)]||matrix[1],value=stage[Number(years)];return clamp(value==null?1:value,1,12)}',
  'starting matrix');
