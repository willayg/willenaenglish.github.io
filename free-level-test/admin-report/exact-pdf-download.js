...
function frame(n,title,c){return `<div class="willena-pdf-frame"></div><div class="willena-pdf-header"><img class="willena-pdf-brand-logo" src="/Assets/Images/color-logo.png" alt="Willena English" style="position:absolute;left:-18px;top:-16px;display:block;width:128px;height:42px;max-width:none;object-fit:contain"><div class="willena-pdf-subbrand" style="position:absolute;left:-18px;top:32px;margin:0">STUDENT LEVEL REPORT</div><div class="willena-pdf-student"><strong>${esc(c.student_name||'Student')}</strong><span>${esc([c.school_name,c.school_grade].filter(Boolean).join(' · '))}</span></div></div><div class="willena-pdf-title-line"><div class="willena-pdf-pill">${title}</div></div><div class="willena-pdf-footer"><span>WILLENA ENGLISH · PLACEMENT REPORT</span><b>${String(n).padStart(2,'0')}</b></div>`}
