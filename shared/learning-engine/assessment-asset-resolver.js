...
var registry={
  ...
  spoon:'spoon.svg',
  pencil:'pencil.svg',
  happy:{url:NOTO+'emoji_u1f600.svg'},
  sad:{url:NOTO+'emoji_u1f622.svg'},
  tired:{url:NOTO+'emoji_u1f62b.svg'},
  angry:{url:NOTO+'emoji_u1f620.svg'},
  hungry:{url:NOTO+'emoji_u1f924.svg'},
  cold:{url:NOTO+'emoji_u1f976.svg'},
  ...
  mouse:{url:NOTO+'emoji_u1f42d.svg'},
  elephant:{url:NOTO+'emoji_u1f418.svg'},
  apple:{url:NOTO+'emoji_u1f34e.svg'},
  'green-apple':{url:NOTO+'emoji_u1f34f.svg'},
  banana:{url:NOTO+'emoji_u1f34c.svg'},
  orange:{url:NOTO+'emoji_u1f34a.svg'},
  grapes:{url:NOTO+'emoji_u1f347.svg'},
  milk:{url:NOTO+'emoji_u1f95b.svg'},
  soup:{url:NOTO+'emoji_u1f963.svg'},
  book:{url:NOTO+'emoji_u1f4d6.svg'},
  'open-book':{url:NOTO+'emoji_u1f4d6.svg'},
  'closed-book':{url:NOTO+'emoji_u1f4d5.svg'},
  books:{url:NOTO+'emoji_u1f4da.svg'},
  notebook:{url:NOTO+'emoji_u1f4d3.svg'},
  ruler:{url:NOTO+'emoji_u1f4cf.svg'},
  pen:{url:NOTO+'emoji_u1f58a.svg'},
  'soccer-ball':{url:NOTO+'emoji_u26bd.svg'},
  basketball:{url:NOTO+'emoji_u1f3c0.svg'},
  baseball:{url:NOTO+'emoji_u26be.svg'},
  tennis:{url:NOTO+'emoji_u1f3be.svg'},
  'ice-skate':{url:NOTO+'emoji_u26f8.svg'},
  ...
  door:{url:NOTO+'emoji_u1f6aa.svg'},
  box:{url:NOTO+'emoji_u1f4e6.svg'},
  ...
  standing:{url:NOTO+'emoji_u1f9cd.svg'},
  ...
  'birthday-cake':{url:NOTO+'emoji_u1f382.svg'},
  'christmas-tree':{url:NOTO+'emoji_u1f384.svg'},
