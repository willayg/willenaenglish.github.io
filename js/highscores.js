...
async function submitScore() {
  ...
  const response = await WillenaAPI.fetch('/.netlify/functions/submit_score', {
    method: 'POST',
...
async function displayHighScores() {
  ...
  const response = await WillenaAPI.fetch('/.netlify/functions/submit_score?game=' + encodeURIComponent(window.game));
