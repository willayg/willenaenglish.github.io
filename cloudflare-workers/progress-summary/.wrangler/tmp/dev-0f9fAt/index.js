...
// .wrangler/tmp/bundle-NyUO0S/checked-fetch.js
    ...
    try {
      ...
      if (section === "leaderboard_stars_class") {
        ...
        if (!classFilter && userId) {
          try {
            const profiles2 = await supabaseSelect(env, "profiles", `id=eq.${userId}&select=class`);
            if (profiles2 && profiles2[0] && profiles2[0].class) {
              classFilter = profiles2[0].class;
            }
          } catch (e) {
...
// .wrangler/tmp/bundle-NyUO0S/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-NyUO0S/middleware-loader.entry.ts
