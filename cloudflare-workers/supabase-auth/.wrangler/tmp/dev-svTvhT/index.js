...
// .wrangler/tmp/bundle-ObHLIp/checked-fetch.js
  ...
  async fetch(request, env, ctx) {
    ...
    try {
      ...
      if (action === "login" && request.method === "POST") {
        ...
        return jsonResponse({ success: true, user: authData.user }, 200, origin, cookies);
      }
...
// .wrangler/tmp/bundle-ObHLIp/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-ObHLIp/middleware-loader.entry.ts
