...
exports.handler = async (event) => {
	...
	if (event.httpMethod === 'GET') {
		...
		// Auth gate: require sb_access cookie
		try {
			...
			if (userErr || !userData || !userData.user) return json(401, { success:false, error:'Not authenticated', requires_auth:true, version:'v2', stage:'invalid_token' });
		} catch {
