...
function makeExportNode(){
  ...
  root.innerHTML=`<style>
    ...
    .cards{display:block}.skill-section{margin:0 0 4mm;counter-reset:pdfq}.skill-heading{font:800 14pt/1.1 Poppins,"Noto Sans KR",sans-serif;margin:0 0 3mm}.skill-grid{display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:2.5mm;align-items:start}.skill-end{grid-column:1/-1;height:1px;background:#4d5260;margin:3mm 0 4mm}
