...
function makeExportNode(){
  ...
  root.innerHTML=`<style>
    ...
    .cards{display:block}.skill-section{margin:0 0 4mm;counter-reset:pdfq}.skill-heading{font:800 14pt/1.1 Poppins,"Noto Sans KR",sans-serif;margin:0 0 3mm}.skill-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:2.5mm;align-items:start}.skill-end{height:1px;background:#4d5260;margin:3mm 0 4mm}
    .question-card{position:relative;box-shadow:none!important;border:1px solid #dfe3ea!important;border-radius:2mm!important;margin:0!important;padding:2.5mm 2.5mm 3mm 7.5mm!important;break-inside:avoid;page-break-inside:avoid;background:#fff!important}.question-card:before{counter-increment:pdfq;content:counter(pdfq) ".";position:absolute;left:2.5mm;top:2.6mm;font:800 8.5pt/1 Poppins,"Noto Sans KR",sans-serif;color:#343844}
...
async function downloadPdf(){
  ...
  try{
    ...
    await window.html2pdf().set({
      ...
      pagebreak:{mode:['css','legacy'],avoid:['.question-card','.vocab-row']}
    }).from(node).save();
