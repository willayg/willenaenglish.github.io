// textbox-render.js - Renders and manages worksheet textboxes
...
(function() {
  ...
  function renderTextbox(boxData, a4, pageData) {
    ...
    selectionFrame.style.zIndex = 1001; // Always above any textbox or guide
    ...
    window.setupTextboxEvents(box, boxData, a4, updateHandlePosition, updateSelectionFrame);
