...
import { getCurrentUserId, ensureSentenceIdsBuilder, saveGameData, findGameByTitle, showTitleConflictModal, generateIncrementedTitle } from '../services/file-service.js?v=20260328c';
import { ensureRegenerateAudioCheckbox, ensureAudioForWordsAndSentences } from '../services/audio-service.js';
import { prepareAndUploadImagesIfNeeded } from '../services/file-service.js?v=20260328c';
