...
@media(max-width:700px){#view-students .page-head h1,#view-classes .page-head h1,#view-naesin .na-fresh-head h1{font-size:1.34rem!important}#view-naesin .na-add{font-size:.72rem!important;padding:9px 12px!important}.teacher-app-switch{padding:3px!important}.teacher-app-switch a{padding:6px 8px!important;font-size:.62rem!important}.top-actions #burger-menu-mount .burger-user-label{display:none!important}.top-actions #burger-menu-mount .burger-btn,.top-actions #burger-menu-mount .hw-notif-btn{width:38px!important;height:36px!important}}
